...
import {Button, Card, Checkbox, FormControlLabel, Grid, makeStyles, TextField, Typography} from "@material-ui/core";
...
export function LoginPage() {
    ...
    const [params, setParams] = useState<LoginParams>(rememberedCredentials || {
        email: "",
        password: ""
    });
    ...
    return <Grid item xs container justify="center" alignContent="center">
                ...
                <Card component={"form"} onSubmit={e => {
                    ...
                    <Grid container direction="column" wrap="nowrap" className="p-2 p-2-all">
                        ...
                        <Grid container justify="flex-end">
                            <Button onClick={clearValues} type="button" variant="contained" className="mr-2"
